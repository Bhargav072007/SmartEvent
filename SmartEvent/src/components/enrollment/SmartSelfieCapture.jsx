...
import { Camera, Upload, CheckCircle2, RotateCcw, Loader2, AlertTriangle, UserCheck } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      {status === 'no_face' && (
        ...
        >
          Make sure your face is well-lit, centered, and not covered. Try again with a clear selfie.
        </motion.p>
      )}
