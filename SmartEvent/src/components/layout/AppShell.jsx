...
import { MapPin, UserCircle, Bell, Shield, Menu, X, Ticket, Camera, Settings, LayoutDashboard, User, ClipboardList } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/gate', label: 'Smart Gate', icon: Camera },
  { path: '/notifications', label: 'Alerts', icon: Bell },
  { path: '/ops', label: 'Ops', icon: Shield },
...
export default function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Top nav */}
      <header className="sticky top-0 z-50 text-white" style={{backgroundColor: '#001E44'}}>
